...
type XRRequestSessionFunction = (mode: XRSessionMode, features: string[], optionalFeatures: string[]) => Promise<XRSession>;
/**
...
export declare class WASM {
     ...
     * @note This api is meant to be used internally.
     */
    readonly webxr_offerSession: XRRequestSessionFunction;
    /**
    ...
    protected _wljs_copy(srcSceneIndex: number, srcIndex: number, dstSceneIndex: number, dstIndex: number, offsetsPtr: number): void;
    /**
...
export interface WASM {
    ...
    _wl_renderer_updateImage: (imageIndex: number, xOffset?: number, yOffset?: number) => number;
